...
class CollageQuest extends StatefulWidget {
  const CollageQuest({super.key});

  @override
  State<CollageQuest> createState() => _CollageQuestState();
}

class _CollageQuestState extends State<CollageQuest> {
        ...
        builder: (controller) {
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: true,
              title:
              BoldText(name: "College QUIZ", fontsize: 22, color: Colors.white),
